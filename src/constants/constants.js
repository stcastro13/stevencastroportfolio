...
export const TimeLineData = [
  ...
  { year: 2012, text: 'Highschool introduction to OOP with Java & C++', },
  { year: 2014, text: 'Started my Degree in Computer Science', },
  { year: 2016, text: 'Internship @ Toyota as a Software Developer', },
  { year: 2017, text: 'Internship @ Sony Pictures as an IT Business Analyst', },
  { year: 2018, text: 'Data Architect @ FiveAcres; Developed (~70%) of Company Intranet',},
  { year: 2019, text: 'BS in Computer Science Achieved at CSULA',},
  { year: 2022, text: 'Created Websites utilizing Next.js, GraphQL, etc.',
},
];